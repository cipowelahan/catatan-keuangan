...
<head>
  ...
  <link rel="stylesheet" href="{{asset('assets/dashboard/css/_all-skins.min.css')}}">
  <link rel="stylesheet" href="{{asset('assets/dashboard/css/loading.css')}}">
  <link rel="stylesheet" href="{{asset('assets/dashboard/css/select2.min.css')}}">
  <link rel="stylesheet" href="{{asset('assets/dashboard/css/summernote.min.css')}}">
  <link rel="stylesheet" href="{{asset('assets/dashboard/css/fileinput.min.css')}}">
  <link rel="stylesheet" href="{{asset('assets/dashboard/css/Chart.min.css')}}">
...
<script src="{{asset('assets/dashboard/js/select2.full.min.js')}}"></script>
<script src="{{asset('assets/dashboard/js/adminlte.min.js')}}"></script>
<script src="{{asset('assets/dashboard/js/notify.min.js')}}"></script>
<script src="{{asset('assets/dashboard/js/bootbox.all.min.js')}}"></script>
<script src="{{asset('assets/dashboard/js/summernote.min.js')}}"></script>
<script src="{{asset('assets/dashboard/js/fileinput.min.js')}}"></script>
